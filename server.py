...
@app.route('/')
def home():
    latest_output_files = [file
                           for file in os.listdir("./output_data") if file.endswith(".csv")]
    latest_scrape_files = [file
                           for file in os.listdir(os.path.dirname(FILE_NAME))]
...
if __name__ == "__main__":
    scrape_ahead_n_complaints(n_ahead=3)
